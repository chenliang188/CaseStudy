...
public class RSAUtil
{
    ...
    */
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println(Utils.toHex(pubModBytes));
        byte[] pubPubExpBytes = pubKey.getPublicExponent().toByteArray();
        System.out.println(Utils.toHex(pubPubExpBytes));
        byte[] priModBytes = priKey.getModulus().toByteArray();
        System.out.println(Utils.toHex(priModBytes));
        byte[] priPriExpBytes = priKey.getPrivateExponent().toByteArray();
        System.out.println(Utils.toHex(priPriExpBytes));
        
        
        
        RSAPublicKey recoveryPubKey = RSAUtil.generateRSAPublicKey(pubModBytes,
                pubPubExpBytes);
        RSAPrivateKey recoveryPriKey = RSAUtil.generateRSAPrivateKey(priModBytes,
                priPriExpBytes);
