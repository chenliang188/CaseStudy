package thecodesample.threads1;
 
public class PrintNumberRunnable3 implements Runnable {
 
    private SyncObject syncObj = null;
 
    private String name = null;
 
    public PrintNumberRunnable3(SyncObject syncObj, String name) {
